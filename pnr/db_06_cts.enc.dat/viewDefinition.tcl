...
create_constraint_mode -name constraints_ss\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/constraints_ss/constraints_ss.sdc]
create_analysis_view -name view_ss -constraint_mode constraints_ss -delay_corner delay_ss -latency_file ${::IMEX::dataVar}/mmmc/views/view_ss/latency.sdc
